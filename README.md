...
---
## Description
In dit onderzoek voert de participant een luistertaak uit waarbij de proefpersoon via het toetsenbord een reactie moet geven op korte geluidsfragmenten. De proefpersoon moet aangeven of de tweede spreker toenadering zoek bij de eerste spreker. Het geluidsfragment bevat geen verstaanbare zinnen en de deelnemer moet dus beoordelen op intonatie. (toets [X], [C],[ V], [B], [N], [M], [,] – [X]=veel verwijdering, [,] veel toenadering).
